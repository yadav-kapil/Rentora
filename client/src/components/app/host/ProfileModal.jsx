      ...
      >
        ...
        <div className="p-6">
          <div className="flex flex-col items-center mb-8">
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white font-outfit">{user?.name || "Host User"}</h3>
            <span className="px-3 py-1 bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 text-xs font-bold rounded-full mt-2 uppercase tracking-wider">Host</span>
          </div>
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-slate-800/60 rounded-xl border border-gray-100 dark:border-slate-700/60">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-gray-800 dark:text-slate-100">{user?.name || "Host User"}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-slate-800/60 rounded-xl border border-gray-100 dark:border-slate-700/60">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-gray-800 dark:text-slate-100">{user?.email || "host@example.com"}</p>
              </div>
            </div>
