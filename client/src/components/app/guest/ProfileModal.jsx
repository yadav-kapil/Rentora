        ...
        >
          ...
          <div className="flex justify-between items-center px-6 py-5 border-b border-gray-100 dark:border-slate-700/80 bg-gray-50/50 dark:bg-slate-800/60 flex-shrink-0">
            <div>
              ...
              <p className="text-xs text-gray-400 dark:text-slate-400 font-medium">Update your personal account details</p>
            </div>
            <button 
              onClick={onClose}
          ...
          <div className="p-6 overflow-y-auto flex-grow">
            <form onSubmit={handleUpdateProfile} className="space-y-5">
              ...
              {/* Bio / About */}
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-slate-400 mb-1 font-ubuntu">Bio / About Me</label>
                <textarea 
                  rows="2"
                  value={bio} 
