    ...
    <div className="max-w-xl mx-auto px-4 py-8 sm:py-12">
      <div className="bg-white dark:bg-slate-800/80 rounded-2xl p-6 sm:p-8 shadow-lg shadow-gray-150/40 dark:shadow-black/40 border dark:border-slate-700/60">
        ...
        <div className="mb-6 text-center sm:text-left">
          ...
          <p className="text-sm text-gray-400 dark:text-slate-400 mt-1.5 font-medium">
            Update the listing information for your Rentora property
          </p>
        </div>
        ...
        <Form className="space-y-6" method="POST">
          ...
          <button 
            ...
            className="w-full bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-500 hover:to-orange-400 text-white py-3 rounded-xl cursor-pointer font-bold transition duration-200 text-sm font-outfit mt-4 shadow-sm disabled:opacity-70 disabled:cursor-not-allowed"
          >
