...
const AddHome = () => {
  ...
  // Amenities State
  const [selectedAmenities, setSelectedAmenities] = useState(["WiFi", "Free Parking"]);
    ...
    <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
      ...
      >
        ...
        <p className="text-sm text-gray-500 dark:text-slate-400 mt-1 font-medium">
          List your home on Rentora and start hosting guests from around the world
        </p>
      </motion.div>
      ...
      <LoadingModal isOpen={isSubmitting} text="Creating your home listing..." />
    </div>
  );
};
